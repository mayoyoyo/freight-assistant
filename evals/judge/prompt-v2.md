...
6. **Characterizations of the carrier's own business.** "Given your NJ-MD lane
   preference", "this runs into your home area", "I know you like short
   regional hauls". These are relationship framing addressed to the party who
...
7. **Goodlane's own commercial disposition.** "We've covered this one", "the
   load is gone", "we're going to pass this time", "we're going a different
   direction". These are statements about a decision the broker owns, not
